...
### INTRODUCTION[​](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api\_abi-restfulapi#introduction) <a href="#introduction" id="introduction"></a>
...
### INDEX[​](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api\_abi-restfulapi#index) <a href="#index" id="index"></a>

\<AUTOGENERATED\_TABLE\_OF\_CONTENTS>

### REFERENCE[​](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api\_abi-restfulapi#reference) <a href="#reference" id="reference"></a>

#### Endpoints[​](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api\_abi-restfulapi#endpoints) <a href="#endpoints" id="endpoints"></a>

#### `/buy_rate`[​](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api\_abi-restfulapi#buy\_rate) <a href="#buy_rate" id="buy_rate"></a>
...
**Example**[**​**](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api\_abi-restfulapi#example)
...
#### `/change24h`[​](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api\_abi-restfulapi#change24h) <a href="#change24h" id="change24h"></a>
...
**Example**[**​**](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api\_abi-restfulapi#example-1)
...
#### `/currencies`[​](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api\_abi-restfulapi#currencies) <a href="#currencies" id="currencies"></a>
...
**Example**[**​**](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api\_abi-restfulapi#example-2)
...
#### `/expectedRate`[​](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api\_abi-restfulapi#expectedrate) <a href="#expectedrate" id="expectedrate"></a>
...
**Example**[**​**](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api\_abi-restfulapi#example-3)
...
#### `/gas_limit`[​](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api\_abi-restfulapi#gas\_limit) <a href="#gas_limit" id="gas_limit"></a>
...
**Example**[**​**](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api\_abi-restfulapi#example-4)
...
#### `/gasLimitConfig`[​](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api\_abi-restfulapi#gaslimitconfig) <a href="#gaslimitconfig" id="gaslimitconfig"></a>
...
**Example**[**​**](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api\_abi-restfulapi#example-5)
...
#### `/hint`[​](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api\_abi-restfulapi#hint) <a href="#hint" id="hint"></a>
...
**Example**[**​**](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api\_abi-restfulapi#example-6)
...
#### `/market`[​](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api\_abi-restfulapi#market) <a href="#market" id="market"></a>
...
**Example**[**​**](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api\_abi-restfulapi#example-7)
...
#### `/quote_amount`[​](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api\_abi-restfulapi#quote\_amount) <a href="#quote_amount" id="quote_amount"></a>
...
| `platformFee` | number  | No       | Platform fee to be charged, in basis points. Read more about platform fees [here](https://docs.kyberswap.com/Legacy/api-abi/restful-api/integrations-platformfees.md).  |
...
**Examples**[**​**](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api\_abi-restfulapi#examples)
...
#### `/all_reserves`[​](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api\_abi-restfulapi#all\_reserves) <a href="#all_reserves" id="all_reserves"></a>
...
| --------------- | ------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| `address`       | string  | The address of the asset in its native chain.                                                                                       |
| `id`            | string  | Reserve ID. Refer to [this section](https://docs.kyberswap.com/Legacy/api-abi/restful-api/reserves-resIDs.md) for more information. |
...
**Reserve Types**[**​**](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api\_abi-restfulapi#reserve-types)

Refer to [this section](https://docs.kyberswap.com/Legacy/api-abi/restful-api/reserves-types.md) for more information on reserve types.
...
**Example**[**​**](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api\_abi-restfulapi#example-8)
...
#### `/reserves`[​](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api\_abi-restfulapi#reserves) <a href="#reserves" id="reserves"></a>
...
**Reserve Types**[**​**](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api\_abi-restfulapi#reserve-types-1)
...
**Example**[**​**](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api\_abi-restfulapi#example-9)
...
#### `/sell_rate`[​](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api\_abi-restfulapi#sell\_rate) <a href="#sell_rate" id="sell_rate"></a>
...
**Example**[**​**](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api\_abi-restfulapi#example-10)
...
#### `/trade_data`[​](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api\_abi-restfulapi#trade\_data) <a href="#trade_data" id="trade_data"></a>
...
| `wallet_id`             | string  | No       | Wallet address that to get fees from the trade. Read more about platform fees [here](https://docs.kyberswap.com/Legacy/api-abi/restful-api/integrations-platformfees.md).                                                                                                                                                                    |
| `wallet_fee`            | integer | No       | Platform fee to be charged, in basis points. Read more about platform fees [here](https://docs.kyberswap.com/Legacy/api-abi/restful-api/integrations-platformfees.md).                                                                                                                                                                       |
| `hint`                  | string  | No       | The trade hint, specifying the trade type, reserve IDs and splits. Read more about building and parsing hints [here](https://docs.kyberswap.com/Legacy/api-abi/restful-api/integrations-restfulapiguide.md#building-hints).                                                                                                                  |
...
**Example**[**​**](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api\_abi-restfulapi#example-11)
...
#### `/transfer_data`[​](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api\_abi-restfulapi#transfer\_data) <a href="#transfer_data" id="transfer_data"></a>
...
**Example**[**​**](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api\_abi-restfulapi#example-12)
...
#### `/users/:user_address/currencies`[​](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api\_abi-restfulapi#usersuser\_addresscurrencies) <a href="#usersuser_addresscurrencies" id="usersuser_addresscurrencies"></a>
...
**Example**[**​**](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api\_abi-restfulapi#example-13)
...
#### `/users/:user_address/currencies/:currency_id/enable_data`[​](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api\_abi-restfulapi#usersuser\_addresscurrenciescurrency\_idenable\_data) <a href="#usersuser_addresscurrenciescurrency_idenable_data" id="usersuser_addresscurrenciescurrency_idenable_data"></a>
...
**Example**[**​**](https://docs.kyberswap.com/Legacy/api-abi/restful-api/api\_abi-restfulapi#example-14)
